  ...
  return (
    ...
    >
      <FlexBox direction="column" gap={1} full my={1}>
        {page == 1 && (
          <>
            <p>Preencha para se tornar um Profissional da Casa</p>
        ...
        {page == 2 && (
          <>
            <p>Registro profissional / Acadêmico</p>
            <FlexBox gap={2.5} justifyContent="space-between">
              <FlexBox direction="column" gap={1}>
                <Input.Radio
                  options={[
                  ...
                  groupName="Registro Profissional / Acadêmico"
                  aria-label="formação"
            ...
            <FlexBox full justifyContent="space-between" mt={2}>
              <Button
                type="button"
                variant="outline"
                onClick={() => setPage(1)}
        ...
        {page == 4 && (
          <>
            <p>Insira suas redes sociais profissionais</p>
